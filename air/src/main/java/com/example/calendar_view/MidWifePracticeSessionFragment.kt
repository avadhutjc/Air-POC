...
class MidWifePracticeSessionFragment : Fragment(R.layout.fragment_mid_wife_practice_session), View.OnClickListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageButton?.setOnClickListener {
             navController.navigate(R.id.action_midWifePracticeSessionFragment_to_midWifeFragment)
        }
